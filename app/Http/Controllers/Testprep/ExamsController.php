...
class ExamsController extends Controller
{
   ...
   // private static $apiContext = '';
    ...
    public function index($type,$palias ='about-ielts')
    {
        $cmsPage =   new CmsPage();
       ...
       $breadcrumSchema =  $this->breadcrumSchema();
        ...
        return view($examblade,compact('getPagetabs','getPageInfo','palias','getJsonTestData','blog_section','pagemeta','breadcrumSchema'));
    }
        ...
        return '<script type="application/ld+json">
{
  ...
  "itemListElement": [{
    ...
    "position": 1, 
    "name": "Home",
    "item": "https://www.masterprep.in/"  
  },{
    "@type": "ListItem", 
    "position": 2, 
    "name": "IELTS",
    "item": "https://www.masterprep.in/exams/ielts"  
  }]
}
</script>';

    }
    protected function getJsonTestData()
    {
