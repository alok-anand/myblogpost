...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('mysql_testprep')->create('category_masters-bkup', function (Blueprint $table) {
    ...
    {
        Schema::connection('mysql_testprep')->dropIfExists('category_masters-bkup');
    }
};
