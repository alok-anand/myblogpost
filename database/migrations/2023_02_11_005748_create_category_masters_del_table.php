...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('mysql_testprep')->create('category_masters-del', function (Blueprint $table) {
    ...
    {
        Schema::connection('mysql_testprep')->dropIfExists('category_masters-del');
    }
};
