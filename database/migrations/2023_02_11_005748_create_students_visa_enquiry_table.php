...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('mysql_testprep')->create('students_visa_enquiry', function (Blueprint $table) {
    ...
    {
        Schema::connection('mysql_testprep')->dropIfExists('students_visa_enquiry');
    }
};
