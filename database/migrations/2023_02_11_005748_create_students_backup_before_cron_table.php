...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('mysql_testprep')->create('students_backup_before_cron', function (Blueprint $table) {
            $table->integer('id');
    ...
    {
        Schema::connection('mysql_testprep')->dropIfExists('students_backup_before_cron');
    }
};
