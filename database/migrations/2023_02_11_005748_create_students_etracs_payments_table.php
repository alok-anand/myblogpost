...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('mysql_testprep')->create('students_etracs_payments', function (Blueprint $table) {
            $table->integer('id');
    ...
    {
        Schema::connection('mysql_testprep')->dropIfExists('students_etracs_payments');
    }
};
