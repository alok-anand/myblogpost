...
<section class="section getting curriculum">
  <div class="custom-container ">
    ...
    <div class="row custom-pills mt-10">
      ...
      @foreach($course_cc as $cc)
      
      <a class="nav-link active" id="v-pills-one-tab" data-toggle="pill" href="#v-pills-one" role="tab" aria-controls="v-pills-one" aria-selected="true">{{ $cc->heading }} </a> 
      @endforeach
