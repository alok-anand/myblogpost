  ...
  <section class="section section__black m-0" id="demo-form">
    <div class="custom-container">
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <form class="black-form" autocomplete="off" method="post" name="demoform" action="{{ url('/testprep/demoform') }}">
            @csrf
            ...
            <div class="form--row">
              ...
              <div class="form__group form--lg__6">
                <select data-size="7" class="pop--select" data-style="btn-pop" data-width="100%" title="Select Course" name="course" >
