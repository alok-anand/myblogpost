      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-sm-4 col-6">
          <div class="footer--menu-body">
            ...
            <ul>
              <li><a href="{{ url('/testprep/exams/ielts') }}" class="text--primary text--regular">IELTS</a></li>
              <li><a href="#" class="text--primary text--regular">TOEFL</a></li>
              <li><a href="#" class="text--primary text--regular">PTE</a></li>
              <li><a href="#" class="text--primary text--regular">CELPIP</a></li>
              <li><a href="#" class="text--primary text--regular">CAEL CE</a></li>
              <li><a href="#" class="text--primary text--regular">UKVI Test</a></li>
            </ul>
          </div>
        </div>
        <div class="col-lg-2 col-sm-4 col-6">
...
<script src="{{ URL::to('/prep/js/custom.js') }}"></script>
@yield('scripts')
<script>
